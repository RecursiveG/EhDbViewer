...
class DataImporter {
  ...
  protected:
    ...
    static std::optional<QString> ScanFolder(const QDir &dir, std::vector<FolderData> *output_list,
                                             QProgressDialog *progress);
    static void SelectThumbnailInFolder(QString dir, QString *filename_out, QString *filepath_out);
};
